...
#define disableX() {GPIOA->MODER&=0XFFFFFCFF;GPIOA->MODER|=0X00000100;GPIOB->MODER&=0XFFCFFFFF;GPIOB->MODER|=0X00100000;GPIO_SetBits(GPIOB,GPIO_Pin_10);GPIO_ResetBits(GPIOA,GPIO_Pin_4);}
...
#define disableY() {GPIOA->MODER&=0XFFFCFFF3;GPIOA->MODER|=0X00010004;GPIO_SetBits(GPIOA,GPIO_Pin_1);GPIO_ResetBits(GPIOA,GPIO_Pin_8);}
