...
#define configTASK_NOTIFICATION_ARRAY_ENTRIES                       1   // was 3
#define configUSE_MUTEXES                                           1
#define configUSE_RECURSIVE_MUTEXES                                 1
#define configUSE_COUNTING_SEMAPHORES                               1   // was 0
#define configUSE_ALTERNATIVE_API                                   0 /* Deprecated! */
#define configQUEUE_REGISTRY_SIZE                                   8   // was 10
#define configUSE_QUEUE_SETS                                        1   // was 0
#define configUSE_TIME_SLICING                                      1   // was 0
#define configUSE_NEWLIB_REENTRANT                                  0
#define configENABLE_BACKWARD_COMPATIBILITY                         0
#define configNUM_THREAD_LOCAL_STORAGE_POINTERS                     0   // was 5
#define configUSE_MINI_LIST_ITEM                                    0   // was 1 (for backward compatibility?)
...
#define configMAX_CO_ROUTINE_PRIORITIES                     2  // was 1

/* Software timer related definitions. */
#define configUSE_TIMERS                                    1
#define configTIMER_TASK_PRIORITY                           ( configMAX_PRIORITIES - 1 )  // was 3	// really???
#define configTIMER_QUEUE_LENGTH                            5  // was 10
#define configTIMER_TASK_STACK_DEPTH                        ( configMINIMAL_STACK_SIZE * 2)  // was configMINIMAL_STACK_SIZE	// seem to be 2048 in ESP-IDF
