...
#define MEM_PURE_ADDR(addr) (volatile unsigned long  *)(addr)
#define BIT_PURE_ADDR(addr, bitnum) MEM_PURE_ADDR(BITBAND(addr, bitnum))
//IO口地址映射
...
// 自定义
#define PAo_addr(n)   BIT_PURE_ADDR(GPIOA_ODR_Addr,n)  //输出 
#define PAi_addr(n)   BIT_PURE_ADDR(GPIOA_IDR_Addr,n)  //输入 

#define PBo_addr(n)   BIT_PURE_ADDR(GPIOB_ODR_Addr,n)  //输出 
#define PBi_addr(n)   BIT_PURE_ADDR(GPIOB_IDR_Addr,n)  //输入 

#define PCo_addr(n)   BIT_PURE_ADDR(GPIOC_ODR_Addr,n)  //输出 
#define PCi_addr(n)   BIT_PURE_ADDR(GPIOC_IDR_Addr,n)  //输入 
