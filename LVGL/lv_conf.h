...
#define LV_INDEV_DEF_READ_PERIOD 42     /*[ms]*/
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(fixedsys) LV_FONT_DECLARE(awesomesyms)

/*Always set a default font*/
#define LV_FONT_DEFAULT &fixedsys
...
#if LV_USE_FS_FATFS
    #define LV_FS_FATFS_LETTER 'L'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
